...
const Faqs = (props) => {
    ...
    return (
                ...
                className='w-[80vw]  sm:w-[500px] md:w-[600px] lg:w-[900px] flex flex-row flex-wrap bg-cA text-left p-4 my-2 rounded-2xl cursor-pointer shadow-lg shadow-cA hover:text-cB transition-colors duration-300'
                >
...
const FaqSection = () => {
    ...
    return (
        <div className='w-full bg-cA text-cC text-center'>
            <div className='max-w-[1240px] mx-auto px-4 py-16 items-center flex flex-col overflow-hidden'>
                <AnimatedOnViewTitle className=" mb-8" text='Frequently Asked Questions' />
                <LayoutGroup>
                <motion.div className=' p-2 md:p-3  items-center flex flex-col rounded-2xl bg-cB' layout >
